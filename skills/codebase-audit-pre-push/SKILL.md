...
description: "Thorough audit before pushing to GitHub. It clears out junk files, dead code, security gaps, and optimization problems. Reviews each file line-by-line for production readiness."  
